...
// Componente Home que muestra la página de inicio con la lista de películas populares.
const Home = () => {
  const { movies, searchMovie, setSearchMovie, setCurrentPage, currentPage } = useHomeFetch();
              ...
              movies.map((movie) => (
                <div className="col-12 col-md-6 col-lg-4">
                  <div className="image-container">
                    ...
                    <div className="color-age">
                      <h6>Lanzamiento: {movie.release_date}</h6>
                    </div>
                  </div>
                </div>
              ))}
